...
public class PublicAccessAdapter extends ArrayAdapter<PublicAccess> implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (access != null) {
            TextView name = v.findViewById(R.id.publicAccessViewName);
            TextView county = v.findViewById(R.id.publicAccessViewCounty);
            TextView directions = v.findViewById(R.id.publicAccessViewDirections);
